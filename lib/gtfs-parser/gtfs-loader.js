...
exports.load = function(dir)  {
	agency = csv.load(dir + "agency.txt");
	calendars = csv.load(dir + "calendar.txt");
	routes = csv.load(dir + "routes.txt");
	shapes = csv.load(dir + "shapes.txt");
	stops = csv.load(dir + "stops.txt");
	stop_times = csv.load(dir + "stop_times.txt");
	trips = csv.load(dir + "trips.txt");
	//console.log(routes);
}
